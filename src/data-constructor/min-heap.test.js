...
describe("MinHeap", () => {
  describe("insert", () => {
    ...
    it("insert multiple elements maintains min heap property", () => {
      const heap = new MinHeap();
  ...
  describe("pop", () => {
    ...
    it("pop maintains min heap property", () => {
      const heap = new MinHeap();
      [10, 5, 15, 20, 8].forEach((v) => heap.insert(v));
    ...
    it("pop all elements in sorted ascending order", () => {
      const heap = new MinHeap();
  ...
  describe("heap property", () => {
    it("smallest element always at root after insert", () => {
      const heap = new MinHeap();
      [1, 3, 5, 7, 9, 2, 4, 6, 8].forEach((v) => heap.insert(v));
      expect(heap.heap[0]).toBe(1);
    });
    ...
    it("heap property preserved after shiftDown", () => {
      ...
      expect(checkMinHeap(heap.heap, 0)).toBe(true);
    });
  });
