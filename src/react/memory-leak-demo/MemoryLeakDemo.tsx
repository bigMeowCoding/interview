...
import {
  LESSON6_INVESTIGATE_CASE_TITLE,
  LESSON6_LEAK_SCENARIO_SNIPPET,
  runInvestigateCleanBatch,
  runInvestigateLeakBatch,
} from "./lesson6-investigate-case";
import GuidedLeakScenario from "./guided-scenario/GuidedLeakScenario";

function readInitialViewMode(): "courses" | "guided" {
  if (typeof window === "undefined") {
    return "courses";
  }
  const qs = new URLSearchParams(window.location.search);
  if (qs.get("guided") === "1" || qs.get("mode") === "guided") {
    return "guided";
  }
  return "courses";
}
...
export default function MemoryLeakDemo() {
  ...
  return (
    <div className="memory-leak-demo">
      <h1>Chrome 内存泄漏 · 6 课上手</h1>
      <p className="sub">
        主线是 DevTools <strong>Memory → Heap snapshot</strong>。
        <strong>按课练习</strong>
        把泄漏类型拆透；切换到「工作坊」则用一整页业务场景配合分步提示，自己追到源码。
        URL：<code>?lesson=5</code>、<code>?guided=1</code> 等可直接定位视图。
      </p>

      <div
        className="memory-demo-mode-switch"
        role="tablist"
        aria-label="学习模式切换"
      >
        <button
          ...
          role="tab"
          className="mode-tab"
          aria-selected={viewMode === "courses"}
      ...
      {viewMode === "guided" ? (
        <GuidedLeakScenario refresh={refresh} />
      ) : (
        <>
              ...
              <div className="lesson-case-block">
                ...
                <ol className="steps lesson1-case-steps">
                  ...
                  <li>
                    ...
                    <strong>Snapshot B</strong> → 用 B 对比
                    A（第一课核心动作）。
                  </li>
                  <li>
            ...
            <>
              <section className="lab-section lab-focused">
                ...
                <div className="stats lesson-stats-subset">
                  ...
                  <div className="stat">
                    intervals: {leakCounters.intervals}
                  </div>
                  <div className="stat">
                    detachedDomRefs: {detachedDomNodes.length}
                  </div>
                ...
                <div className="lesson-case-block lesson5-case-alone">
                  ...
                  <ol className="steps lesson5-case-steps">
                    ...
                    <li>
                      ...
                      <strong>泄漏：等价挂载副作用 ×15</strong> → Snapshot B′，
                      在 Comparison 里结合前几课搜监听、interval、Detached。
                    </li>
          ...
          {lesson.index === 6 ? (
            <>
              <section className="lab-section lab-focused">
                ...
                <p className="hint lesson-lab-scope">
                  下面节选是<strong>业务味写法示意</strong>
                  ，实验区批量按钮的行为与其
                  <strong>语义等价</strong>
                  ：真实堆里会通过 retaining path 连到本 demo 在{" "}
                  <code>state.ts</code> 中的登记表（等价于图中的{" "}
                  <code>notifyPanelDebugAnchors.push(panel)</code>）。
                </p>
                <pre
                  className="lesson-source-snippet"
                  aria-label="疑点源码示意"
                >
                  {LESSON6_LEAK_SCENARIO_SNIPPET.trimEnd()}
                </pre>

                <h2 className="lab-heading" style={{ marginTop: 24 }}>
                  实验区 · 第六课 · 计数与配套演练
                </h2>
                <p className="hint lesson-lab-scope">
                  每跑一次「示意面板打开」（泄漏），<code>eventListeners</code>
                  、 <code>intervals</code>、<code>detachedDomRefs</code> 各追加
                  1；干净批次的等价 teardown 不会让这三项越过本页的登记计数。
                </p>
                <div className="stats lesson-stats-subset">
                  <div className="stat">
                    eventListeners: {leakCounters.eventListeners}
                ...
                <div className="lesson-case-block lesson6-case-alone">
                  <h3 className="lesson6-case-title">
                    第六课配套案例：{LESSON6_INVESTIGATE_CASE_TITLE}
                  </h3>
                  <p className="hint lesson6-case-lead">
                    按讲义做两轮{" "}
                    <strong>A → 同一操作 ×15 → B → Comparison</strong>
                    ：先只靠读上文源码写下你的「三条怀疑」，再看页面计数与堆是否一致；最后用修复区分项验证归因。
                  </p>
                  <ol className="steps lesson6-case-steps">
                    <li>
                      <strong>重置案例环境</strong> → Snapshot A。
                    </li>
                    <li>
                      <strong>泄漏：示意面板打开 ×15</strong> → Snapshot B →
                      Comparison，并对照疑点源码逐项理解 retaining path。
                    </li>
                    <li>
                      <strong>重置</strong> → A′ →{" "}
                      <strong>干净：对等 teardown ×15</strong> →
                      B′：三项计数应仍为 0。
                    </li>
                  </ol>
                  <div className="btn-row">
              ...
              <section className="lab-section lab-focused">
                ...
                <p className="hint">
                  做完 Comparison
                  后可逐项点下面按钮，再拍快照，看堆里是否只对应该类引用在回落。
                </p>
                <div className="btn-row">
                  <button
                    type="button"
                ...
                <div className="lesson-case-block lesson2-case-alone">
                  ...
                  <ol className="steps lesson2-case-steps">
                    ...
                    <li>
                      ...
                      <strong>Snapshot B</strong> → Comparison(A,B)；detached
                      应为 <strong>0</strong>。
                    </li>
                    <li>
              ...
              <section className="lab-section lab-focused">
                ...
                <div className="lesson-case-block lesson3-case-alone">
                  ...
                  <ol className="steps lesson3-case-steps">
                    <li>
                      <strong>重置案例环境</strong> → 拍{" "}
                      <strong>Snapshot A</strong>。
                    </li>
                    <li>
                      <strong>干净：同步注册并清理 ×15</strong> → 拍 Snapshot
                      B。
                    </li>
                    <li>
                      <strong>重置案例环境</strong> → Snapshot A′ →{" "}
            ...
            <>
              <section className="lab-section lab-focused">
                ...
                <p className="hint lesson-lab-scope">
                  ...
                  <code>~1MB strings</code> 应与「泄漏」次数对齐，便于对照 Heap
                  里 Retained 排序。
                </p>
                ...
                <div className="lesson-case-block lesson4-case-alone">
                  ...
                  <ol className="steps lesson4-case-steps">
                    ...
                    <li>
                      <strong>干净：临时大字符串 ×15</strong>（不写入全局缓存）→
                      拍 Snapshot B → Comparison；<code>~1MB strings</code> 应为{" "}
                      <strong>0</strong>。
                    </li>
                    <li>
                      <strong>重置案例环境</strong> → Snapshot A′ →
                      <strong> 泄漏：缓存 ~1MB 字符串 ×15</strong> → Snapshot
                      B′。
                    </li>
                    <li>
                      （可选）多次点下方单次泄漏，或点
